  ...
  return {
    ...
    execute: function () {
      ...
      _export("Screen", Screen = (_dec = ccclass('Screen'), _dec2 = property(Prefab), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Node), _dec6 = property(_crd && collier === void 0 ? (_reportPossibleCrUseOfcollier({
        ...
        createSquare() {
          var randomX = Math.random() * 400 - 200;
          var position = new Vec3(randomX, 421.611, 0);
          var squareNode = instantiate(this.squarePrefab);
          this.node.addChild(squareNode);
          this.squares.push(squareNode);
          squareNode.setPosition(position);
          var sprite = squareNode.getChildByName("square").getComponent(Sprite); // Lấy component Sprite của squareNode
        ...
        hideAllSquares() {
          var squaresContainer = this.node; // Thay bằng node cha của các square
