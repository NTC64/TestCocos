    ...
    execute: function () {
      ...
      _export("MovingCircle", MovingCircle = (_dec = ccclass('MovingCircle'), _dec(_class = class MovingCircle extends Component {
        ...
        moveCircle(moveTime) {
          ...
          const startPosition = new Vec3(-203.75, -117.002, 0); // Vị trí kết thúc của hình tròn

          const endPosition = new Vec3(191.574, -117.002, 0); // Tween để di chuyển từ vị trí ban đầu đến vị trí kết thúc
        ...
        moveBack(moveTime) {
          ...
          const endPosition = new Vec3(191.574, -117.002, 0); // Tween để di chuyển từ vị trí kết thúc về vị trí ban đầu
